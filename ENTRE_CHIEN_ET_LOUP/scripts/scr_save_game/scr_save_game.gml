...
function save_game()
{
	...
	var _switches_names = struct_get_names(global.switches);
	var _nb_switches = array_length(_switches_names);
	for (var _i = 0; _i < _switches_names; _i ++)
	{
		struct_set(_struct_to_save, _switches_names[_i], variable_struct_get(global.switches, _switches_names[_i]));
	}
