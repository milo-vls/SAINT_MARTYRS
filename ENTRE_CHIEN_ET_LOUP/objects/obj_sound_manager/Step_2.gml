...
if nb_sounds_to_play > 0
{
	...
	array_foreach(sounds_to_play, function(_sound_to_play)
	{
		...
		{
			audio_play_sound_at(_sound_to_play.sound_id, mouse_x, mouse_y, listener_z, 420.69, 30000, 0.3,  false , SOUND_PRIORITY.EFFECT, 10, 0, _sound_to_play.random_pitch ? random_range(0.2, 1.9) : 1);
		}
		else
		{
