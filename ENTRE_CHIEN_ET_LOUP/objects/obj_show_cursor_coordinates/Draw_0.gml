...
draw_text(text_coordinates_x + 40 , text_coordinates_y + 25 , string(int64(room_x_to_map_x(mouse_x))) + " x " + string(int64(room_y_to_map_y(mouse_y))));
if debug_mode
	draw_text(text_coordinates_x + 25 , text_coordinates_y + 250 , string(mouse_x) + " x " + string(mouse_y));