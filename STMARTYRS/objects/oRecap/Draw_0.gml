...
switch (currentState)
{
	...
	case  RECAP_STATES.RAPPEL_MISSION:{
		titleScribble.draw(TITLE_RECAP_X, TITLE_RECAP_Y);
	...
	case RECAP_STATES.UNITS:{
		//TEXTE
		titleScribble.draw(TITLE_RECAP_X, TITLE_RECAP_Y);
		rappelScribble.draw(TITLE_RECAP_X, RECAP_RECAP_Y);
		unitsScribble.draw(TITLE_RECAP_X, UNITS_TEXT_RECAP_Y, unitsTypist);
		show_debug_message(TITLE_RECAP_X);
		show_debug_message(TITLE_RECAP_Y);
