...
function txtDefault(){
 ...
 //ne se joue qu'une fois par jour
 if global.char[0].nbInteractionCeJour == 0
{
	global.char[0].nbInteractionCeJour = 1;
	switch (global.char[0].proximite)
	{
		#region	0		=>	9
			case 0 :{
