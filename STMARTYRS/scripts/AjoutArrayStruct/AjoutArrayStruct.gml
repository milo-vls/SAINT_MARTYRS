...
function addScriptedCrime(_idKiller, _nomPrenom, _dateJour, _lastOfKiller,_x, _y, _heure = noone, _minute = noone, _portrait = noone, _indices = noone)
{
	ojeu.crime[ojeu.nbCrimes] = new setCrime(_idKiller, _nomPrenom, _dateJour, _lastOfKiller,_x, _y, false, _heure, _minute, c_white, false, _portrait, _indices)
	ojeu.nbCrimes ++;
}
